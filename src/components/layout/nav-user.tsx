...
import { getUserEmail, getUsername } from '@/lib/storage';
...
export function NavUser() {
  ...
  const userName = getUsername() || t('unknownUser');
  const userEmail = getUserEmail() || t('unknownEmail');
        ...
        <DropdownMenu>
          ...
          >
            ...
            {userMenuGroups.map((group, groupIndex) => {
              const visibleItems = group.items.filter((item) => !item.ssoOnly);
